package beto.banco.usuario.configuracion;
...
public class RabbitMQConfig {
	...
	public FanoutExchange fanoutExchange() {
		return new FanoutExchange("beto.usercreated.fanout");
	}
	...
	public Queue userCreatedLogQueue() {
		return new Queue("beto.usuariocreado.log.queue", true);
	}
